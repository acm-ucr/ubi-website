...
const StillInterest = () => {
  return (
    <div className="relative my-10 flex w-full flex-col items-center">
      ...
      <p className="text-ubi-blue font-volkhov flex w-3/4 flex-col justify-center pt-5 pb-10 text-center text-[2.4rem] font-bold tracking-wider md:w-full md:text-[6.5vw]">
        Still Interested?
      </p>
      ...
      <motion.div
        ...
        className="bg-ubi-rose top-[90%] h-min w-3/4 justify-self-center rounded-4xl shadow-xl shadow-black/20 md:w-4/5"
      >
        ...
        <hr className="border-ubi-blue mx-auto w-[50vw] border-t-4 pb-5 md:w-[68vw]"></hr>
        <p className="text-ubi-darkred-100 font-volkhov text-center text-[4vw] font-extrabold md:px-20 md:text-left md:text-[2vw]">
          University Blood{" "}
          <span className="text-ubiboard-red-300">Initiative</span>
        </p>
        <div className="flex flex-col md:flex-row">
          <p className="text-ubi-blue px-10 pt-2 text-xl text-wrap md:w-[45vw] md:px-20 md:pb-8 md:text-[2vw]">
