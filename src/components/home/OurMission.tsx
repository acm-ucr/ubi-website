  ...
  return (
    <div className="relative flex w-4/5 p-5">
      <div className="bg-ubi-lightpink h-full w-full rounded-4xl shadow-xl shadow-black/20">
        <div>
          <p className="font-volkhov text-ubi-blue float-left px-6 pt-7 text-8xl font-bold tracking-wider">
            Our Mission
          </p>
          <p className="text-ubi-blue px-6 pt-7 text-3xl leading-relaxed font-medium">
