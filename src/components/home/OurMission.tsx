  ...
  return (
    <div className="relative flex w-full justify-center p-5 lg:w-4/5">
      <div className="bg-ubi-lightpink h-full w-9/10 rounded-4xl shadow-xl shadow-black/20 lg:w-full">
        <div>
          <p className="font-volkhov text-ubi-blue px-6 pt-7 text-center text-6xl font-bold tracking-wider lg:float-left lg:text-7xl">
            Our Mission
          </p>
          <p className="text-ubi-blue px-6 pt-7 pb-5 text-center text-2xl leading-relaxed font-medium lg:pb-0 lg:text-left">
