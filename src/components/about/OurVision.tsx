  ...
  return (
    <div className="bg-ubi-tan flex w-9/10 items-center justify-center pb-16 md:w-4/5">
      <div className="flex flex-col items-center gap-10 md:flex-row">
        <motion.div initial={{filter: "blur(100px)"}} animate={{filter: "none"}} className="relative h-50 w-4/5 shadow-[10px_8px_0px_#BEB1B1] md:h-97 md:w-9/20">
          <Image
            src={OurVisionImg}
            alt="OurVisionImg"
            fill
        ...
        transition={{ duration: 0.8 }} className="bg-ubi-pink flex w-9/10 flex-col justify-center rounded-[40px] p-10 shadow-[10px_8px_0px_#BEB1B1] md:w-1/2">
