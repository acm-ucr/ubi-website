  ...
  return (
    <div className="flex w-full flex-col items-center">
      ...
      <motion.div
        ...
        className="bg-ubi-pink flex w-4/5 items-center justify-center rounded-4xl px-6 py-12 shadow-xl shadow-black/20 lg:rounded-2xl"
      >
      ...
      <motion.div
        ...
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
        className="mt-12 flex w-4/5 flex-col items-center rounded-4xl bg-[#FFF6DF] p-6 shadow-xl lg:hidden"
      >
        <div className="flex w-full items-center pb-3">
